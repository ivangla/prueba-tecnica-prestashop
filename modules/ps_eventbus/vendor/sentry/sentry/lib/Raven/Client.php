...
class Raven_Client
{
    ...
    public function __construct($options_or_dsn = null, $options = array())
    {
        ...
        $this->trace = (bool) Raven_Util::get($options, 'trace', \true);
        ...
        $this->verify_ssl = Raven_Util::get($options, 'verify_ssl', \true);
        ...
        $this->sdk = Raven_Util::get($options, 'sdk', array('name' => 'sentry-php', 'version' => self::VERSION));
        ...
        if (Raven_Util::get($options, 'install_default_breadcrumb_handlers', \true)) {
            $this->registerDefaultBreadcrumbHandlers();
        }
        if (Raven_Util::get($options, 'install_shutdown_handler', \true)) {
    ...
    {
        return array('ps_eventbus_v3_0_7\Raven_Processor_SanitizeDataProcessor');
    }
    /**
    ...
    public function captureException($exception, $data = null, $logger = null, $vars = null)
    {
        ...
        do {
            ...
            $exc_data['stacktrace'] = array('frames' => Raven_Stacktrace::get_stack_info($trace, $this->trace, $vars, $this->message_limit, $this->prefixes, $this->app_path, $this->excluded_app_paths, $this->serializer, $this->reprSerializer));
            $exceptions[] = $exc_data;
    ...
    public function capture($data, $stack = null, $vars = null)
    {
        ...
        if (!empty($stack) && !isset($data['stacktrace']) && !isset($data['exception'])) {
            $data['stacktrace'] = array('frames' => Raven_Stacktrace::get_stack_info($stack, $this->trace, $vars, $this->message_limit, $this->prefixes, $this->app_path, $this->excluded_app_paths, $this->serializer, $this->reprSerializer));
        }
        $this->sanitize($data);
        $this->process($data);
    ...
    private function triggerAutoload()
    {
        ...
        if (!\class_exists('ps_eventbus_v3_0_7\\Raven_Stacktrace')) {
