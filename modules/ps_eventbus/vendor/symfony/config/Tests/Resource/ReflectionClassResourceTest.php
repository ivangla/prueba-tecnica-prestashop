...
class ReflectionClassResourceTest extends TestCase
{
    ...
    {
        $res = new ReflectionClassResource(new \ReflectionClass(\Symfony\Component\Config\Tests\Resource\DummyInterface::class));
...
EOPHP;
    ...
    public function provideHashedSignature()
    {
        ...
        (yield [1, 1, 'class %s implements ' . \Symfony\Component\Config\Tests\Resource\DummyInterface::class]);
    ...
    {
        $res = new ReflectionClassResource(new \ReflectionClass(\Symfony\Component\Config\Tests\Resource\TestEventSubscriber::class));
        $this->assertTrue($res->isFresh(0));
        \Symfony\Component\Config\Tests\Resource\TestEventSubscriber::$subscribedEvents = [123];
    ...
    {
        $res = new ReflectionClassResource(new \ReflectionClass(\Symfony\Component\Config\Tests\Resource\TestServiceSubscriber::class));
        $this->assertTrue($res->isFresh(0));
        \Symfony\Component\Config\Tests\Resource\TestServiceSubscriber::$subscribedServices = [123];
        $this->assertFalse($res->isFresh(0));
        $res = new ReflectionClassResource(new \ReflectionClass(\Symfony\Component\Config\Tests\Resource\TestServiceSubscriber::class));
        $this->assertTrue($res->isFresh(0));
    }
    ...
    {
        $res = new ReflectionClassResource(new \ReflectionClass(\Symfony\Component\Config\Tests\Resource\TestServiceWithStaticProperty::class));
        $this->assertTrue($res->isFresh(0));
        \Symfony\Component\Config\Tests\Resource\TestServiceWithStaticProperty::$initializedObject = new \Symfony\Component\Config\Tests\Resource\TestServiceWithStaticProperty();
        $this->assertTrue($res->isFresh(0));
    }
}
