...
class FileLoaderTest extends TestCase
{
    public function testImportWithFileLocatorDelegation()
    {
        ...
        $fileLoader = new \Symfony\Component\Config\Tests\Loader\TestFileLoader($locatorMock);
        $fileLoader->setSupports(\false);
        $fileLoader->setCurrentDir('.');
        $additionalLoader = new \Symfony\Component\Config\Tests\Loader\TestFileLoader($locatorMockForAdditionalLoader);
    ...
    {
        $locatorMock = $this->getMockBuilder('Symfony\\Component\\Config\\FileLocatorInterface')->getMock();
        $loader = new \Symfony\Component\Config\Tests\Loader\TestFileLoader($locatorMock);
    ...
    {
        $loader = new \Symfony\Component\Config\Tests\Loader\TestFileLoader(new FileLocator(__DIR__));
