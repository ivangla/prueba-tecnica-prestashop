...
class TreeBuilderTest extends TestCase
{
    ...
    public function testPrototypedArrayNodeUseTheCustomNodeBuilder()
    {
        ...
        $this->assertInstanceOf('Symfony\\Component\\Config\\Tests\\Fixtures\\BarNode', $root->getNode(\true)->getPrototype());
    }
    public function testAnExtendedNodeBuilderGetsPropagatedToTheChildren()
    {
        $builder = new TreeBuilder();
        $builder->root('propagation')->children()->setNodeClass('extended', 'Symfony\\Component\\Config\\Definition\\Builder\\BooleanNodeDefinition')->node('foo', 'extended')->end()->arrayNode('child')->children()->node('foo', 'extended')->end()->end()->end()->end();
