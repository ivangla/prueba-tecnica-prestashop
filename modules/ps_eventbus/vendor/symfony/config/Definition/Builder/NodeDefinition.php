...
abstract class NodeDefinition implements \Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
     ...
     */
    public function __construct($name, \Symfony\Component\Config\Definition\Builder\NodeParentInterface $parent = null)
    {
        $this->parent = $parent;
        $this->name = $name;
    }
    ...
    public function getNode($forceRootNode = \false)
    {
        ...
        if (null !== $this->normalization) {
            $this->normalization->before = \Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->normalization->before);
        }
        if (null !== $this->validation) {
            $this->validation->rules = \Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->validation->rules);
        }
    ...
    {
        if (null === $this->validation) {
            $this->validation = new \Symfony\Component\Config\Definition\Builder\ValidationBuilder($this);
        }
    ...
    {
        if (null === $this->merge) {
            $this->merge = new \Symfony\Component\Config\Definition\Builder\MergeBuilder($this);
        }
        return $this->merge;
    }
    /**
    ...
    {
        if (null === $this->normalization) {
            $this->normalization = new \Symfony\Component\Config\Definition\Builder\NormalizationBuilder($this);
        }
