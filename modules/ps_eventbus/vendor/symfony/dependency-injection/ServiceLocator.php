...
class ServiceLocator implements PsrContainerInterface
{
     ...
     * @internal
     */
    public function withContext($externalId, \Symfony\Component\DependencyInjection\Container $container)
    {
        $locator = clone $this;
    ...
    private function createServiceNotFoundMessage($id)
    {
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \Symfony\Component\DependencyInjection\ServiceSubscriberInterface::class)) {
