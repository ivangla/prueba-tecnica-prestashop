...
class ServiceReferenceGraph
{
    ...
    public function connect($sourceId, $sourceValue, $destId, $destValue = null, $reference = null)
    {
        ...
        $edge = new \Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphEdge($sourceNode, $destNode, $reference, $lazy, $weak, $byConstructor);
    ...
    private function createNode($id, $value)
    {
        ...
        return $this->nodes[$id] = new \Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode($id, $value);
    }
}
