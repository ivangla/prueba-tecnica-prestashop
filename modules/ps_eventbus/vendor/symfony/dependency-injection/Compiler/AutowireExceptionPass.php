 ...
 */
class AutowireExceptionPass implements \Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $autowirePass;
    private $inlineServicePass;
    public function __construct(\Symfony\Component\DependencyInjection\Compiler\AutowirePass $autowirePass, \Symfony\Component\DependencyInjection\Compiler\InlineServiceDefinitionsPass $inlineServicePass)
    {
