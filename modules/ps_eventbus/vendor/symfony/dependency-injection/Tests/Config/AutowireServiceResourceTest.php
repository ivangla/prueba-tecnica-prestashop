...
class AutowireServiceResourceTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->class = \Symfony\Component\DependencyInjection\Tests\Config\Foo::class;
    ...
    {
        $oldResource = AutowirePass::createResourceForClass(new \ReflectionClass(\Symfony\Component\DependencyInjection\Tests\Config\Foo::class));
    ...
    {
        $resource = new AutowireServiceResource('ps_eventbus_v3_0_7\\Some\\Non\\Existent\\Class', $this->file, []);
