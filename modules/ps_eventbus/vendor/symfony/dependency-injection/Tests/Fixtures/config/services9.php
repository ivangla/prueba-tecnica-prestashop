...
use ps_eventbus_v3_0_7\Bar\FooClass;
...
return function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $c) {
    ...
    $s->set('method_call1', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->file(\realpath(__DIR__ . '/../includes/foo.php'))->call('setBar', [ref('foo')])->call('setBar', [ref('foo2')->nullOnInvalid()])->call('setBar', [ref('foo3')->ignoreOnInvalid()])->call('setBar', [ref('foobaz')->ignoreOnInvalid()])->call('setBar', [expr('service("foo").foo() ~ (container.hasParameter("foo") ? parameter("foo") : "default")')]);
    ...
    $s->set('service_from_static_method', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->factory(['ps_eventbus_v3_0_7\\Bar\\FooClass', 'getInstance']);
