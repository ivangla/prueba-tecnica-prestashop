...
class ProjectServiceContainer extends Container
{
    ...
    {
        $this->services['service_with_method_call_and_factory'] = $instance = new \ps_eventbus_v3_0_7\Bar\FooClass();
        $instance->setBar(\ps_eventbus_v3_0_7\Bar\FooClass::getInstance());
        return $instance;
    }
    ...
    {
        return ['env(FOO)' => 'ps_eventbus_v3_0_7\\Bar\\FaooClass'];
    }
}
