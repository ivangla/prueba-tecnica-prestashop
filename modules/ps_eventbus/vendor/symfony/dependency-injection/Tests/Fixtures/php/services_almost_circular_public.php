...
class Symfony_DI_PhpDumper_Test_Almost_Circular_Public extends Container
{
    ...
    {
        return ['Psr\\Container\\ContainerInterface' => \true, 'Symfony\\Component\\DependencyInjection\\ContainerInterface' => \true, 'bar2' => \true, 'bar6' => \true, 'config' => \true, 'config2' => \true, 'level2' => \true, 'level3' => \true, 'level4' => \true, 'level5' => \true, 'level6' => \true, 'logger2' => \true, 'manager4' => \true, 'multiuse1' => \true, 'subscriber2' => \true];
    }
    ...
    {
        $this->services['bar'] = $instance = new \ps_eventbus_v3_0_7\BarCircular();
    ...
    {
        $this->services['bar3'] = $instance = new \ps_eventbus_v3_0_7\BarCircular();
        $a = ${($_ = isset($this->services['foobar3']) ? $this->services['foobar3'] : ($this->services['foobar3'] = new \ps_eventbus_v3_0_7\FoobarCircular())) && \false ?: '_'};
    ...
    protected function getFooService()
    {
        ...
        return $this->services['foo'] = new \ps_eventbus_v3_0_7\FooCircular($a);
    }
    /**
    ...
    {
        $a = new \ps_eventbus_v3_0_7\BarCircular();
        $this->services['foo2'] = $instance = new \ps_eventbus_v3_0_7\FooCircular($a);
    ...
    protected function getFoobarService()
    {
        ...
        return $this->services['foobar'] = new \ps_eventbus_v3_0_7\FoobarCircular($a);
    }
    /**
    ...
    protected function getFoobar2Service()
    {
        ...
        return $this->services['foobar2'] = new \ps_eventbus_v3_0_7\FoobarCircular($a);
    }
    /**
    ...
    {
        return $this->services['foobar3'] = new \ps_eventbus_v3_0_7\FoobarCircular();
    }
    /**
