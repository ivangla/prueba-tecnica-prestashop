...
class ProjectServiceContainer extends Container
{
    ...
    {
        return ['Psr\\Container\\ContainerInterface' => \true, 'Symfony\\Component\\DependencyInjection\\ContainerInterface' => \true, 'configurator_service' => \true, 'configurator_service_simple' => \true, 'decorated.pif-pouf' => \true, 'decorator_service.inner' => \true, 'factory_simple' => \true, 'inlined' => \true, 'new_factory' => \true, 'tagged_iterator_foo' => \true];
    }
    ...
    protected function getConfiguredServiceService()
    {
        ...
        $a = new \ps_eventbus_v3_0_7\ConfClass();
    ...
    protected function getConfiguredServiceSimpleService()
    {
        ...
        (new \ps_eventbus_v3_0_7\ConfClass('bar'))->configureStdClass($instance);
        return $instance;
    }
    /**
    ...
    {
        $a = ${($_ = isset($this->services['foo.baz']) ? $this->services['foo.baz'] : $this->getFoo_BazService()) && \false ?: '_'};
        $this->services['foo'] = $instance = \ps_eventbus_v3_0_7\Bar\FooClass::getInstance('foo', $a, ['bar' => 'foo is bar', 'foobar' => 'bar'], \true, $this);
        $instance->foo = 'bar';
        $instance->moo = $a;
    ...
    {
        $this->services['foo.baz'] = $instance = \ps_eventbus_v3_0_7\BazClass::getInstance();
        \ps_eventbus_v3_0_7\BazClass::configureStatic1($instance);
        return $instance;
    }
    /**
    ...
    {
        return new \ps_eventbus_v3_0_7\Bar\FooClass(${($_ = isset($this->services['deprecated_service']) ? $this->services['deprecated_service'] : $this->getDeprecatedServiceService()) && \false ?: '_'});
    }
    /**
    ...
    {
        $a = new \ps_eventbus_v3_0_7\FactoryClass();
        $a->foo = 'bar';
    ...
    protected function getTaggedIteratorService()
    {
        return $this->services['tagged_iterator'] = new \ps_eventbus_v3_0_7\Bar(new RewindableGenerator(function () {
            ...
            (yield 1 => ${($_ = isset($this->services['tagged_iterator_foo']) ? $this->services['tagged_iterator_foo'] : ($this->services['tagged_iterator_foo'] = new \ps_eventbus_v3_0_7\Bar())) && \false ?: '_'});
        }, 2));
    }
    /**
