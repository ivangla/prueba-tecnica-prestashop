...
class ProjectServiceContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->normalizedIds = ['psr\\container\\containerinterface' => 'Psr\\Container\\ContainerInterface', 'symfony\\component\\dependencyinjection\\containerinterface' => 'Symfony\\Component\\DependencyInjection\\ContainerInterface'];
        ...
        $this->aliases = ['Psr\\Container\\ContainerInterface' => 'service_container', 'Symfony\\Component\\DependencyInjection\\ContainerInterface' => 'service_container', 'alias_for_alias' => 'foo', 'alias_for_foo' => 'foo'];
    }
    /**
    ...
    protected function getBarService()
    {
        ...
        $this->services['bar'] = $instance = new \ps_eventbus_v3_0_7\Bar\FooClass('foo', $a, $this->getParameter('foo_bar'));
    ...
    {
        $this->services['baz'] = $instance = new \ps_eventbus_v3_0_7\Baz();
    ...
    protected function getConfiguredServiceSimpleService()
    {
        ...
        ${($_ = isset($this->services['configurator_service_simple']) ? $this->services['configurator_service_simple'] : ($this->services['configurator_service_simple'] = new \ps_eventbus_v3_0_7\ConfClass('bar'))) && \false ?: '_'}->configureStdClass($instance);
        return $instance;
    }
    /**
    ...
    {
        $a = ${($_ = isset($this->services['foo.baz']) ? $this->services['foo.baz'] : $this->getFoo_BazService()) && \false ?: '_'};
        $this->services['foo'] = $instance = \ps_eventbus_v3_0_7\Bar\FooClass::getInstance('foo', $a, [$this->getParameter('foo') => 'foo is ' . $this->getParameter('foo') . '', 'foobar' => $this->getParameter('foo')], \true, $this);
        $instance->foo = 'bar';
        $instance->moo = $a;
    ...
    {
        $this->services['foo_with_inline'] = $instance = new \ps_eventbus_v3_0_7\Foo();
    ...
    {
        return $this->services['lazy_context'] = new \ps_eventbus_v3_0_7\LazyContext(new RewindableGenerator(function () {
    ...
    {
        return $this->services['lazy_context_ignore_invalid_ref'] = new \ps_eventbus_v3_0_7\LazyContext(new RewindableGenerator(function () {
    ...
    protected function getMethodCall1Service()
    {
        ...
        $this->services['method_call1'] = $instance = new \ps_eventbus_v3_0_7\Bar\FooClass();
    ...
    {
        return $this->services['service_from_static_method'] = \ps_eventbus_v3_0_7\Bar\FooClass::getInstance();
    }
    /**
    ...
    {
        return $this->services['tagged_iterator'] = new \ps_eventbus_v3_0_7\Bar(new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0));
    }
    /**
    ...
    {
        $this->services['configurator_service'] = $instance = new \ps_eventbus_v3_0_7\ConfClass();
    ...
    {
        return $this->services['configurator_service_simple'] = new \ps_eventbus_v3_0_7\ConfClass('bar');
    }
    /**
    ...
    protected function getFactorySimpleService()
    {
        ...
        return $this->services['factory_simple'] = new \ps_eventbus_v3_0_7\SimpleFactoryClass('foo');
    }
    /**
    ...
    {
        $this->services['inlined'] = $instance = new \ps_eventbus_v3_0_7\Bar();
        $instance->pub = 'pub';
    ...
    {
        $this->services['new_factory'] = $instance = new \ps_eventbus_v3_0_7\FactoryClass();
        $instance->foo = 'bar';
        return $instance;
    }
    /**
    ...
    {
        return $this->services['tagged_iterator_foo'] = new \ps_eventbus_v3_0_7\Bar();
    }
    /**
    ...
    {
        return ['baz_class' => 'BazClass', 'foo_class' => 'ps_eventbus_v3_0_7\\Bar\\FooClass', 'foo' => 'bar'];
    }
}
