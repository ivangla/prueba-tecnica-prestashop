...
class Symfony_DI_PhpDumper_Test_Almost_Circular_Private extends Container
{
    ...
    {
        $this->services['bar2'] = $instance = new \ps_eventbus_v3_0_7\BarCircular();
        $instance->addFoobar(new \ps_eventbus_v3_0_7\FoobarCircular(${($_ = isset($this->services['foo2']) ? $this->services['foo2'] : $this->getFoo2Service()) && \false ?: '_'}));
        return $instance;
    }
    /**
    ...
    protected function getBar3Service()
    {
        ...
        $a = new \ps_eventbus_v3_0_7\FoobarCircular();
    ...
    protected function getFooService()
    {
        ...
        $this->services['foo'] = $instance = new \ps_eventbus_v3_0_7\FooCircular($a);
        $a->addFoobar(new \ps_eventbus_v3_0_7\FoobarCircular($instance));
        return $instance;
    }
    /**
    ...
    protected function getFoo2Service()
    {
        ...
        return $this->services['foo2'] = new \ps_eventbus_v3_0_7\FooCircular($a);
    }
    /**
