...
class ExtensionCompilerPassTest extends TestCase
{
    ...
    {
        $extension1 = new \Symfony\Component\DependencyInjection\Tests\Compiler\CompilerPassExtension('extension1');
        $extension2 = new \Symfony\Component\DependencyInjection\Tests\Compiler\DummyExtension('extension2');
        $extension3 = new \Symfony\Component\DependencyInjection\Tests\Compiler\DummyExtension('extension3');
        $extension4 = new \Symfony\Component\DependencyInjection\Tests\Compiler\CompilerPassExtension('extension4');
...
class CompilerPassExtension extends \Symfony\Component\DependencyInjection\Tests\Compiler\DummyExtension implements CompilerPassInterface
{
}
