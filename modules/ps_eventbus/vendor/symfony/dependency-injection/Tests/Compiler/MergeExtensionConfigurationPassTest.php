...
class MergeExtensionConfigurationPassTest extends TestCase
{
    ...
    {
        $extension = $this->getMockBuilder(\Symfony\Component\DependencyInjection\Tests\Compiler\FooExtension::class)->setMethods(['load'])->getMock();
    ...
    {
        $extension = $this->getMockBuilder(\Symfony\Component\DependencyInjection\Tests\Compiler\FooExtension::class)->setMethods(['getConfiguration'])->getMock();
        $extension->expects($this->exactly(2))->method('getConfiguration')->willReturn(new \Symfony\Component\DependencyInjection\Tests\Compiler\FooConfiguration());
        $container = new ContainerBuilder(new ParameterBag());
        $container->registerExtension($extension);
        $container->prependExtensionConfig('foo', ['bar' => \true]);
        $pass = new MergeExtensionConfigurationPass();
    ...
    public function testOverriddenEnvsAreMerged()
    {
        ...
        $container->registerExtension(new \Symfony\Component\DependencyInjection\Tests\Compiler\FooExtension());
    ...
    public function testProcessedEnvsAreIncompatibleWithResolve()
    {
        ...
        $container = new ContainerBuilder();
        $container->registerExtension(new \Symfony\Component\DependencyInjection\Tests\Compiler\BarExtension());
    ...
    {
        $container = new ContainerBuilder();
        $container->registerExtension(new \Symfony\Component\DependencyInjection\Tests\Compiler\ThrowingExtension());
...
class FooExtension extends Extension
{
    ...
    {
        return new \Symfony\Component\DependencyInjection\Tests\Compiler\FooConfiguration();
    }
