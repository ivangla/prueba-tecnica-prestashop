...
class AutowirePassTest extends TestCase
{
    public function testProcess()
    {
        ...
        $barDefinition = $container->register('bar', \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class);
        $barDefinition->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $this->assertCount(1, $container->getDefinition('bar')->getArguments());
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, (string) $container->getDefinition('bar')->getArgument(0));
    }
    /**
     * @requires PHP 5.6
     */
    public function testProcessVariadic()
    {
        ...
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, (string) $container->getDefinition('fooVariadic')->getArgument(0));
    }
    /**
     * @group legacy
    ...
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\B::class);
        $cDefinition = $container->register('c', \Symfony\Component\DependencyInjection\Tests\Compiler\C::class);
        $cDefinition->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $this->assertCount(1, $container->getDefinition('c')->getArguments());
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\B::class, (string) $container->getDefinition('c')->getArgument(0));
    }
    /**
     * @group legacy
    ...
    {
        $container = new ContainerBuilder();
        $container->setAlias(\Symfony\Component\DependencyInjection\Tests\Compiler\AInterface::class, \Symfony\Component\DependencyInjection\Tests\Compiler\B::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\B::class);
        $cDefinition = $container->register('c', \Symfony\Component\DependencyInjection\Tests\Compiler\C::class);
        $cDefinition->setAutowired(\true);
        (new ResolveClassPass())->process($container);
    ...
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\F::class);
        $gDefinition = $container->register('g', \Symfony\Component\DependencyInjection\Tests\Compiler\G::class);
        $gDefinition->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $this->assertCount(3, $container->getDefinition('g')->getArguments());
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\F::class, (string) $container->getDefinition('g')->getArgument(0));
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\F::class, (string) $container->getDefinition('g')->getArgument(1));
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\F::class, (string) $container->getDefinition('g')->getArgument(2));
    }
    public function testCompleteExistingDefinition()
    {
        $container = new ContainerBuilder();
        $container->register('b', \Symfony\Component\DependencyInjection\Tests\Compiler\B::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\DInterface::class, \Symfony\Component\DependencyInjection\Tests\Compiler\F::class);
        $hDefinition = $container->register('h', \Symfony\Component\DependencyInjection\Tests\Compiler\H::class)->addArgument(new Reference('b'));
        ...
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\DInterface::class, (string) $container->getDefinition('h')->getArgument(1));
    }
    public function testCompleteExistingDefinitionWithNotDefinedArguments()
    {
        ...
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\B::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\DInterface::class, \Symfony\Component\DependencyInjection\Tests\Compiler\F::class);
        $hDefinition = $container->register('h', \Symfony\Component\DependencyInjection\Tests\Compiler\H::class)->addArgument('')->addArgument('');
        $hDefinition->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $this->assertCount(2, $container->getDefinition('h')->getArguments());
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\B::class, (string) $container->getDefinition('h')->getArgument(0));
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\DInterface::class, (string) $container->getDefinition('h')->getArgument(1));
    }
    /**
     * @group legacy
    ...
    {
        $container = new ContainerBuilder();
        $container->register('c1', \Symfony\Component\DependencyInjection\Tests\Compiler\CollisionA::class);
        $container->register('c2', \Symfony\Component\DependencyInjection\Tests\Compiler\CollisionB::class);
        $container->register('c3', \Symfony\Component\DependencyInjection\Tests\Compiler\CollisionB::class);
        $aDefinition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\CannotBeAutowired::class);
    ...
    public function testPrivateConstructorThrowsAutowireException()
    {
        ...
        $container = new ContainerBuilder();
        $container->autowire('private_service', \Symfony\Component\DependencyInjection\Tests\Compiler\PrivateConstructor::class);
        $pass = new AutowirePass(\true);
        $pass->process($container);
    }
    ...
    public function testTypeNotGuessable()
    {
        ...
        $container = new ContainerBuilder();
        $container->register('a1', \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $container->register('a2', \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $aDefinition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\NotGuessableArgument::class);
        $aDefinition->setAutowired(\true);
        $pass = new AutowirePass();
        $pass->process($container);
    }
    public function testTypeNotGuessableWithSubclass()
    {
        ...
        $container = new ContainerBuilder();
        $container->register('a1', \Symfony\Component\DependencyInjection\Tests\Compiler\B::class);
        $container->register('a2', \Symfony\Component\DependencyInjection\Tests\Compiler\B::class);
        $aDefinition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\NotGuessableArgumentForSubclass::class);
        $aDefinition->setAutowired(\true);
        $pass = new AutowirePass();
        $pass->process($container);
    }
    ...
    public function testTypeNotGuessableUnionType()
    {
        ...
        $aDefinition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\UnionClasses::class);
        $aDefinition->setAutowired(\true);
        $pass = new AutowirePass();
        $pass->process($container);
    }
    public function testTypeNotGuessableWithTypeSet()
    {
        ...
        $container->register('a1', \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $container->register('a2', \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $aDefinition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\NotGuessableArgument::class);
        $aDefinition->setAutowired(\true);
        $pass = new AutowirePass();
        $pass->process($container);
        $this->assertCount(1, $container->getDefinition('a')->getArguments());
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, (string) $container->getDefinition('a')->getArgument(0));
    }
    public function testWithTypeSet()
    {
        ...
        $container->register('c1', \Symfony\Component\DependencyInjection\Tests\Compiler\CollisionA::class);
        $container->register('c2', \Symfony\Component\DependencyInjection\Tests\Compiler\CollisionB::class);
        $container->setAlias(\Symfony\Component\DependencyInjection\Tests\Compiler\CollisionInterface::class, 'c2');
        $aDefinition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\CannotBeAutowired::class);
        $aDefinition->setAutowired(\true);
        $pass = new AutowirePass();
        $pass->process($container);
        $this->assertCount(1, $container->getDefinition('a')->getArguments());
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\CollisionInterface::class, (string) $container->getDefinition('a')->getArgument(0));
    }
    /**
     * @group legacy
    ...
    {
        $container = new ContainerBuilder();
        $coopTilleulsDefinition = $container->register('coop_tilleuls', \Symfony\Component\DependencyInjection\Tests\Compiler\LesTilleuls::class);
        ...
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class, $dunglasDefinition->getClass());
        ...
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class, $lilleDefinition->getClass());
    }
    public function testResolveParameter()
    {
        $container = new ContainerBuilder();
        $container->setParameter('class_name', \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $barDefinition = $container->register('bar', '%class_name%');
        $barDefinition->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, $container->getDefinition('bar')->getArgument(0));
    }
    public function testOptionalParameter()
    {
        ...
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $optDefinition = $container->register('opt', \Symfony\Component\DependencyInjection\Tests\Compiler\OptionalParameter::class);
        $optDefinition->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $definition = $container->getDefinition('opt');
        $this->assertNull($definition->getArgument(0));
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, $definition->getArgument(1));
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, $definition->getArgument(2));
    }
    /**
     * @requires PHP 8
     */
    ...
    {
        $container = new ContainerBuilder();
        $optDefinition = $container->register('opt', \Symfony\Component\DependencyInjection\Tests\Compiler\UnionNull::class);
        $optDefinition->setAutowired(\true);
        (new AutowirePass())->process($container);
        $definition = $container->getDefinition('opt');
        $this->assertNull($definition->getArgument(0));
    ...
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\CollisionInterface::class, \Symfony\Component\DependencyInjection\Tests\Compiler\CollisionA::class);
        $optDefinition = $container->register('opt', \Symfony\Component\DependencyInjection\Tests\Compiler\UnionNull::class);
        $optDefinition->setAutowired(\true);
        (new AutowirePass())->process($container);
        $definition = $container->getDefinition('opt');
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\Compiler\CollisionInterface::class, $definition->getArgument(0));
    }
    public function testDontTriggerAutowiring()
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $container->register('bar', \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
    ...
    public function testClassNotFoundThrowsException()
    {
        ...
        $container = new ContainerBuilder();
        $aDefinition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\BadTypeHintedArgument::class);
        $aDefinition->setAutowired(\true);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class);
        $pass = new AutowirePass();
        $pass->process($container);
    }
    public function testParentClassNotFoundThrowsException()
    {
        ...
        $container = new ContainerBuilder();
        $aDefinition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\BadParentTypeHintedArgument::class);
        $aDefinition->setAutowired(\true);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class);
        $pass = new AutowirePass();
        $pass->process($container);
    ...
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class)->setAbstract(\true);
        $container->register('foo', \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $container->register('bar', \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class)->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
    }
    public function testSomeSpecificArgumentsAreSet()
    {
        ...
        $container->register('foo', \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class);
        $container->register('multiple', \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArguments::class)->setAutowired(\true)->setArguments([1 => new Reference('foo'), 3 => ['bar']]);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $definition = $container->getDefinition('multiple');
        $this->assertEquals([new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArguments::class), new Reference('foo'), new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class, \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArguments::class), ['bar']], $definition->getArguments());
    }
    public function testScalarArgsCannotBeAutowired()
    {
        ...
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class);
        $container->register('arg_no_type_hint', \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArguments::class)->setArguments([1 => 'foo'])->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
    }
    /**
    ...
    public function testUnionScalarArgsCannotBeAutowired()
    {
        ...
        $container = new ContainerBuilder();
        $container->register('union_scalars', \Symfony\Component\DependencyInjection\Tests\Compiler\UnionScalars::class)->setAutowired(\true);
        (new AutowirePass())->process($container);
    }
    public function testNoTypeArgsCannotBeAutowired()
    {
        ...
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas::class);
        $container->register('arg_no_type_hint', \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArguments::class)->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
    }
    /**
    ...
    public function testOptionalScalarNotReallyOptionalUsesDefaultValue()
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class);
        $definition = $container->register('not_really_optional_scalar', MultipleArgumentsOptionalScalarNotReallyOptional::class)->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
    ...
    public function testOptionalScalarArgsDontMessUpOrder()
    {
        ...
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class);
        $container->register('with_optional_scalar', \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArgumentsOptionalScalar::class)->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $definition = $container->getDefinition('with_optional_scalar');
        $this->assertEquals([
            new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArgumentsOptionalScalar::class),
            // use the default value
            'default_val',
            new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class),
    ...
    public function testOptionalScalarArgsNotPassedIfLast()
    {
        ...
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class);
        $container->register('with_optional_scalar_last', \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArgumentsOptionalScalarLast::class)->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $definition = $container->getDefinition('with_optional_scalar_last');
        $this->assertEquals([new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArgumentsOptionalScalarLast::class), new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class, \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArgumentsOptionalScalarLast::class)], $definition->getArguments());
    }
    ...
    public function testSetterInjection()
    {
        ...
        // test setFoo args
        $this->assertEquals([new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, \Symfony\Component\DependencyInjection\Tests\Compiler\SetterInjection::class)], $methodCalls[1][1]);
    }
    public function testWithNonExistingSetterAndAutowiring()
    {
        ...
        $container = new ContainerBuilder();
        $definition = $container->register(CaseSensitiveClass::class, CaseSensitiveClass::class)->setAutowired(\true);
    ...
    public function testExplicitMethodInjection()
    {
        ...
        $this->assertEquals([new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\SetterInjection::class)], $methodCalls[0][1]);
    }
    /**
     * @group legacy
    ...
    {
        $container = new ContainerBuilder();
        $container->register('bar', \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class)->setProperty('a', [new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class)]);
        $pass = new AutowirePass();
        $pass->process($container);
        $this->assertSame(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, $container->getDefinition('autowired.' . \Symfony\Component\DependencyInjection\Tests\Compiler\A::class)->getClass());
    }
    /**
    ...
    {
        $startingResource = AutowirePass::createResourceForClass(new \ReflectionClass(\Symfony\Component\DependencyInjection\Tests\Compiler\ClassForResource::class));
    ...
    {
        $container = new ContainerBuilder();
        $container->register('class_not_exist', \Symfony\Component\DependencyInjection\Tests\Compiler\OptionalServiceClass::class);
        $barDefinition = $container->register('bar', \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class);
        $barDefinition->setAutowired(\true);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $pass = new AutowirePass();
    ...
    public function testSetterInjectionCollisionThrowsException()
    {
        ...
        $container->register('c1', \Symfony\Component\DependencyInjection\Tests\Compiler\CollisionA::class);
        $container->register('c2', \Symfony\Component\DependencyInjection\Tests\Compiler\CollisionB::class);
        $aDefinition = $container->register('setter_injection_collision', \Symfony\Component\DependencyInjection\Tests\Compiler\SetterInjectionCollision::class);
        $aDefinition->setAutowired(\true);
        (new AutowireRequiredMethodsPass())->process($container);
        $pass = new AutowirePass();
        try {
    ...
    public function testInterfaceWithNoImplementationSuggestToWriteOne()
    {
        ...
        $container = new ContainerBuilder();
        $aDefinition = $container->register('my_service', \Symfony\Component\DependencyInjection\Tests\Compiler\K::class);
        $aDefinition->setAutowired(\true);
        (new AutowireRequiredMethodsPass())->process($container);
        $pass = new AutowirePass();
        $pass->process($container);
    ...
    {
        $container = new ContainerBuilder();
        $container->register('deprecated', 'Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\DeprecatedClass')->setDeprecated(\true);
        $container->register('foo', \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $container->register('bar', \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class)->setAutowired(\true);
        $pass = new AutowirePass();
        $pass->process($container);
    ...
    public function testEmptyStringIsKept()
    {
        ...
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class);
        $container->register('foo', \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArgumentsOptionalScalar::class)->setAutowired(\true)->setArguments(['', '']);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $this->assertEquals([new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArgumentsOptionalScalar::class), '', new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Lille::class)], $container->getDefinition('foo')->getArguments());
    }
    public function testWithFactory()
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class);
        $definition = $container->register('a', \Symfony\Component\DependencyInjection\Tests\Compiler\A::class)->setFactory([\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, 'create'])->setAutowired(\true);
        (new ResolveClassPass())->process($container);
        (new AutowirePass())->process($container);
        $this->assertEquals([new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Foo::class, \Symfony\Component\DependencyInjection\Tests\Compiler\A::class)], $definition->getArguments());
    }
    /**
    ...
    public function testNotWireableCalls($method, $expectedMsg)
    {
        $this->expectException('Symfony\\Component\\DependencyInjection\\Exception\\AutowiringFailedException');
        $container = new ContainerBuilder();
        $foo = $container->register('foo', \Symfony\Component\DependencyInjection\Tests\Compiler\NotWireable::class)->setAutowired(\true)->addMethodCall('setBar', [])->addMethodCall('setOptionalNotAutowireable', [])->addMethodCall('setOptionalNoTypeHint', [])->addMethodCall('setOptionalArgNoAutowireable', []);
        if ($method) {
    ...
    {
        $container = new ContainerBuilder();
        $container->setAlias(\Symfony\Component\DependencyInjection\Tests\Compiler\IInterface::class, 'i');
        $container->register('i', \Symfony\Component\DependencyInjection\Tests\Compiler\I::class);
        $container->register('j', \Symfony\Component\DependencyInjection\Tests\Compiler\J::class)->setAutowired(\true);
        $pass = new AutowirePass();
        $pass->process($container);
    }
    /**
    ...
    {
        $container = new ContainerBuilder();
        $container->register('aClass', \Symfony\Component\DependencyInjection\Tests\Compiler\A::class);
        $container->setAlias(\Symfony\Component\DependencyInjection\Tests\Compiler\AInterface::class, 'aClass');
        $container->register('bar', \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class)->setProperty('a', [new TypedReference(\Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\A::class, \Symfony\Component\DependencyInjection\Tests\Compiler\Bar::class)]);
        $pass = new AutowirePass();
        $pass->process($container);
    }
    public function testExceptionWhenAliasExists()
    {
        ...
        $container->setAlias(\Symfony\Component\DependencyInjection\Tests\Compiler\IInterface::class, 'i');
        $container->register('i', \Symfony\Component\DependencyInjection\Tests\Compiler\I::class);
        $container->register('i2', \Symfony\Component\DependencyInjection\Tests\Compiler\I::class);
