...
class IntegrationTest extends TestCase
{
    ...
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\ServiceSubscriberStub::class)->addTag('container.service_subscriber')->setPublic(\true);
        $container->register(\Symfony\Component\DependencyInjection\Tests\Compiler\DecoratedServiceSubscriber::class)->setDecoratedService(\Symfony\Component\DependencyInjection\Tests\Compiler\ServiceSubscriberStub::class);
        $container->compile();
        $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Tests\Compiler\DecoratedServiceSubscriber::class, $container->get(\Symfony\Component\DependencyInjection\Tests\Compiler\ServiceSubscriberStub::class));
    }
    /**
    ...
    {
        $container = new ContainerBuilder();
        $container->registerForAutoconfiguration(\Symfony\Component\DependencyInjection\Tests\Compiler\IntegrationTestStub::class);
        ...
        $container = new ContainerBuilder();
        $container->registerForAutoconfiguration(\Symfony\Component\DependencyInjection\Tests\Compiler\IntegrationTestStub::class)->addTag('from_autoconfigure');
...
class IntegrationTestStub extends \Symfony\Component\DependencyInjection\Tests\Compiler\IntegrationTestStubParent
{
}
