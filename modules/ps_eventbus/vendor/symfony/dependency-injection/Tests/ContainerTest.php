...
class ContainerTest extends TestCase
{
    ...
    {
        return [['foo_bar', 'FooBar'], ['foo.bar', 'Foo_Bar'], ['foo.bar_baz', 'Foo_BarBaz'], ['foo._bar', 'Foo_Bar'], ['foo_.bar', 'Foo_Bar'], ['_foo', 'Foo'], ['.foo', '_Foo'], ['foo_', 'Foo'], ['foo.', 'Foo_'], ['ps_eventbus_v3_0_7\\foo\\bar', 'Foo_Bar']];
    }
    /**
    ...
    public function testGetServiceIds()
    {
        ...
        $sc = new \Symfony\Component\DependencyInjection\Tests\ProjectServiceContainer();
        $sc->set('foo', $obj = new \stdClass());
    ...
    {
        $sc = new \Symfony\Component\DependencyInjection\Tests\LegacyProjectServiceContainer();
        $sc->set('foo', $obj = new \stdClass());
    ...
    {
        $c = new \Symfony\Component\DependencyInjection\Tests\ProjectServiceContainer();
    ...
    public function testLegacyGet()
    {
        ...
        $this->assertSame($sc->__foo_bar, $sc->get('foo_bar'), '->get() returns the service if a get*Method() is defined');
        $this->assertSame($sc->__foo_baz, $sc->get('foo.baz'), '->get() returns the service if a get*Method() is defined');
        $this->assertSame($sc->__foo_baz, $sc->get('ps_eventbus_v3_0_7\\foo\\baz'), '->get() returns the service if a get*Method() is defined');
    ...
    public function testLegacyHas()
    {
        ...
        $this->assertTrue($sc->has('foo_bar'), '->has() returns true if a get*Method() is defined');
        $this->assertTrue($sc->has('foo.baz'), '->has() returns true if a get*Method() is defined');
        $this->assertTrue($sc->has('ps_eventbus_v3_0_7\\foo\\baz'), '->has() returns true if a get*Method() is defined');
    }
