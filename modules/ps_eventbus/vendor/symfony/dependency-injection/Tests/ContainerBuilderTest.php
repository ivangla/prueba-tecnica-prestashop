...
class ContainerBuilderTest extends TestCase
{
    ...
    {
        $builder = new ContainerBuilder();
        $definitions = ['foo' => new Definition('ps_eventbus_v3_0_7\\Bar\\FooClass'), 'bar' => new Definition('BarClass')];
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo', 'ps_eventbus_v3_0_7\\Bar\\FooClass');
    ...
    {
        $builder = new ContainerBuilder();
        $builder->autowire('foo', 'ps_eventbus_v3_0_7\\Bar\\FooClass');
    ...
    public function testGetServiceIds()
    {
        ...
        $builder->register('bar', 'stdClass');
        $this->assertEquals(['service_container', 'foo', 'bar', 'Psr\\Container\\ContainerInterface', 'Symfony\\Component\\DependencyInjection\\ContainerInterface'], $builder->getServiceIds(), '->getServiceIds() returns all defined service ids');
    }
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo1', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setFile(__DIR__ . '/Fixtures/includes/foo.php');
        $builder->register('foo2', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setFile(__DIR__ . '/Fixtures/includes/%file%.php');
        $builder->setParameter('file', 'foo');
        $this->assertInstanceOf('ps_eventbus_v3_0_7\\Bar\\FooClass', $builder->get('foo1'), '->createService() requires the file defined by the service definition');
        $this->assertInstanceOf('ps_eventbus_v3_0_7\\Bar\\FooClass', $builder->get('foo2'), '->createService() replaces parameters in the file provided by the service definition');
    }
    public function testCreateProxyWithRealServiceInstantiator()
    {
        ...
        $this->assertSame('ps_eventbus_v3_0_7\\Bar\\FooClass', \get_class($foo1));
    }
    ...
    public function testCreateServiceArguments()
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->addArgument(['foo' => '%value%', '%value%' => 'foo', new Reference('bar'), '%%unescape_it%%']);
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setFactory('ps_eventbus_v3_0_7\\Bar\\FooClass::getInstance');
        $builder->register('qux', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setFactory(['ps_eventbus_v3_0_7\\Bar\\FooClass', 'getInstance']);
        $builder->register('bar', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setFactory([new Definition('ps_eventbus_v3_0_7\\Bar\\FooClass'), 'getInstance']);
        $builder->register('baz', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setFactory([new Reference('bar'), 'getInstance']);
    ...
    public function testCreateServiceMethodCalls()
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->addMethodCall('setBar', [['%value%', new Reference('bar')]]);
        $builder->setParameter('value', 'bar');
    ...
    public function testCreateServiceMethodCallsWithEscapedParam()
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->addMethodCall('setBar', [['%%unescape_it%%']]);
        $builder->setParameter('value', 'bar');
    ...
    public function testCreateServiceProperties()
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setProperty('bar', ['%value%', new Reference('bar'), '%%unescape_it%%']);
        $builder->setParameter('value', 'bar');
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo1', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setConfigurator('sc_configure');
        $builder->register('foo2', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setConfigurator(['%class%', 'configureStatic']);
        $builder->setParameter('class', 'BazClass');
        $builder->register('baz', 'BazClass');
        $builder->register('foo3', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setConfigurator([new Reference('baz'), 'configure']);
        $builder->register('foo4', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setConfigurator([$builder->getDefinition('baz'), 'configure']);
        $builder->register('foo5', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setConfigurator('foo');
    ...
    public function testCreateSyntheticService()
    {
        ...
        $builder = new ContainerBuilder();
        $builder->register('foo', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->setSynthetic(\true);
        $builder->get('foo');
    }
    public function testCreateServiceWithExpression()
    {
        ...
        $builder->register('foo', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->addArgument(['foo' => new Expression('service("bar").foo ~ parameter("bar")')]);
    ...
    public function testMerge()
    {
        ...
        $container->setResourceTracking(\false);
        $container->register('foo', 'ps_eventbus_v3_0_7\\Bar\\FooClass');
    ...
    public function testEnvInId()
    {
        ...
        $expected = [PsrContainerInterface::class => \true, ContainerInterface::class => \true, 'baz_%env(BAR)%' => \true, 'bar_%env(BAR)%' => \true];
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->addTag('foo', ['foo' => 'foo'])->addTag('bar', ['bar' => 'bar'])->addTag('foo', ['foofoo' => 'foofoo']);
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo', 'ps_eventbus_v3_0_7\\Bar\\FooClass')->addTag('kernel.event_listener', ['foo' => 'foo'])->addTag('kenrel.event_listener', ['bar' => 'bar']);
    ...
    {
        $container = new ContainerBuilder();
        $container->setDefinition('foo', $definition = new Definition('ps_eventbus_v3_0_7\\Bar\\FooClass'));
    ...
    public function testAddObjectResource()
    {
        $container = new ContainerBuilder();
        $container->setResourceTracking(\false);
        $container->addObjectResource(new \ps_eventbus_v3_0_7\BarClass());
    ...
    public function testExtension()
    {
        $container = new ContainerBuilder();
        $container->setResourceTracking(\false);
        $container->registerExtension($extension = new \ps_eventbus_v3_0_7\ProjectExtension());
    ...
    public function testLazyLoadedService()
    {
        ...
        $loader->load(function (ContainerBuilder $container) {
            $container->set('a', new \ps_eventbus_v3_0_7\BazClass());
    ...
    public function testThrowsCircularExceptionForCircularAliases()
    {
        ...
        $builder = new ContainerBuilder();
        $builder->setAliases(['foo' => new Alias('app.test_class'), 'app.test_class' => new Alias('ps_eventbus_v3_0_7\\App\\TestClass'), 'ps_eventbus_v3_0_7\\App\\TestClass' => new Alias('app.test_class')]);
    ...
    {
        $container = new ContainerBuilder();
        $container->register(\Symfony\Component\DependencyInjection\Tests\A::class)->setPublic(\true);
        $bDefinition = $container->register('b', \Symfony\Component\DependencyInjection\Tests\B::class);
        $bDefinition->setAutowired(\true);
        $bDefinition->setPublic(\true);
        $container->compile();
        $this->assertEquals(\Symfony\Component\DependencyInjection\Tests\A::class, (string) $container->getDefinition('b')->getArgument(0));
    }
    public function testClassFromId()
    {
        $container = new ContainerBuilder();
        $unknown = $container->register('ps_eventbus_v3_0_7\\Acme\\UnknownClass');
        $autoloadClass = $container->register(CaseSensitiveClass::class);
        $container->compile();
        $this->assertSame('ps_eventbus_v3_0_7\\Acme\\UnknownClass', $unknown->getClass());
    ...
    public function testNoClassFromNamespaceClassIdWithLeadingSlash()
    {
        ...
        $container = new ContainerBuilder();
        $container->register('\\' . \Symfony\Component\DependencyInjection\Tests\FooClass::class);
        $container->compile();
    }
    ...
    {
        $container = new ContainerBuilder();
        $container->register('foo_service', ServiceLocator::class)->setPublic(\true)->addArgument(['bar' => new ServiceClosureArgument(new Reference('bar_service')), 'baz' => new ServiceClosureArgument(new TypedReference('baz_service', 'stdClass'))]);
    ...
    public function testArgumentsHaveHigherPriorityThanBindings()
    {
        ...
        $container->register('foo', SimilarArgumentsDummy::class)->setPublic(\true)->setBindings([CaseSensitiveClass::class => new Reference('class.via.bindings'), '$token' => '1234'])->setArguments(['$class1' => new Reference('class.via.argument')]);
    ...
    public function testUninitializedSyntheticReference()
    {
        ...
        $container->register('bar', 'stdClass')->setPublic(\true)->setShared(\false)->setProperty('foo', new Reference('foo', ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE));
        $container->compile();
    ...
    public function testScalarService()
    {
        ...
        $c->register('foo', 'string')->setPublic(\true)->setFactory([ScalarFactory::class, 'getSomeValue']);
        $c->compile();
