...
class FileLoaderTest extends TestCase
{
    ...
    public function testImportWithGlobPattern()
    {
        ...
        $loader = new \Symfony\Component\DependencyInjection\Tests\Loader\TestFileLoader($container, new FileLocator(self::$fixturesPath));
        ...
        $expected = ['a string', 'foo' => 'bar', 'values' => [0, 'integer' => 4, 100 => null, 'true', \true, \false, 'on', 'off', 'float' => 1.3, 1000.3, 'a string', ['foo', 'bar']], 'mixedcase' => ['MixedCaseKey' => 'value'], 'constant' => \PHP_EOL, 'bar' => '%foo%', 'escape' => '@escapeme', 'foo_bar' => new Reference('foo_bar')];
    ...
    public function testRegisterClasses()
    {
        ...
        $loader = new \Symfony\Component\DependencyInjection\Tests\Loader\TestFileLoader($container, new FileLocator(self::$fixturesPath . '/Fixtures'));
    ...
    public function testMissingParentClass()
    {
        ...
        $this->assertMatchesRegularExpression('{Class "?Symfony\\\\Component\\\\DependencyInjection\\\\Tests\\\\Fixtures\\\\Prototype\\\\BadClasses\\\\MissingClass"? not found}', $container->getDefinition(MissingParent::class)->getErrors()[0]);
    }
