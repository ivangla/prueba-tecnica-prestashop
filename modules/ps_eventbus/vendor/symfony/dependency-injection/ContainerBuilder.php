 ...
 */
class ContainerBuilder extends \Symfony\Component\DependencyInjection\Container implements \Symfony\Component\DependencyInjection\TaggedContainerInterface
{
    /**
    ...
    public function __construct(ParameterBagInterface $parameterBag = null)
    {
        ...
        $this->setDefinition('service_container', (new \Symfony\Component\DependencyInjection\Definition(\Symfony\Component\DependencyInjection\ContainerInterface::class))->setSynthetic(\true)->setPublic(\true));
        $this->setAlias(PsrContainerInterface::class, new \Symfony\Component\DependencyInjection\Alias('service_container', \false));
        $this->setAlias(\Symfony\Component\DependencyInjection\ContainerInterface::class, new \Symfony\Component\DependencyInjection\Alias('service_container', \false));
    }
    /**
     ...
     * @see Reference
     */
    public function get($id, $invalidBehavior = \Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE)
    {
    ...
    private function doGet($id, $invalidBehavior = \Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, array &$inlineServices = null, $isConstructorArgument = \false)
    {
        $id = $this->normalizeId($id);
        ...
        try {
            if (\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $invalidBehavior) {
                return parent::get($id, $invalidBehavior);
            }
            if ($service = parent::get($id, \Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE)) {
                return $service;
            }
        ...
        try {
            ...
            if (\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE !== $invalidBehavior) {
                return null;
            }
            throw $e;
        }
    ...
    public function setAlias($alias, $id)
    {
        ...
        if (\is_string($id)) {
            $id = new \Symfony\Component\DependencyInjection\Alias($this->normalizeId($id));
        } elseif (!$id instanceof \Symfony\Component\DependencyInjection\Alias) {
    ...
    {
        return $this->setDefinition($id, new \Symfony\Component\DependencyInjection\Definition($class));
    }
    /**
    ...
    {
        return $this->setDefinition($id, (new \Symfony\Component\DependencyInjection\Definition($class))->setAutowired(\true));
    }
    /**
     ...
     */
    private function createService(\Symfony\Component\DependencyInjection\Definition $definition, array &$inlineServices, $isConstructorArgument = \false, $id = null, $tryProxy = \true)
    {
        if (null === $id && isset($inlineServices[$h = \spl_object_hash($definition)])) {
            return $inlineServices[$h];
        }
        if ($definition instanceof \Symfony\Component\DependencyInjection\ChildDefinition) {
        ...
        if ($callable = $definition->getConfigurator()) {
            if (\is_array($callable)) {
                ...
                if ($callable[0] instanceof \Symfony\Component\DependencyInjection\Reference) {
                    $callable[0] = $this->doGet((string) $callable[0], $callable[0]->getInvalidBehavior(), $inlineServices);
                } elseif ($callable[0] instanceof \Symfony\Component\DependencyInjection\Definition) {
    ...
    private function doResolveServices($value, array &$inlineServices = [], $isConstructorArgument = \false)
    {
            ...
            $value = new RewindableGenerator(function () use($value) {
                foreach ($value->getValues() as $k => $v) {
                    ...
                    foreach (self::getInitializedConditionals($v) as $s) {
                        if (!$this->doGet($s, \Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE)) {
                            continue 2;
                        }
                    }
        ...
        } elseif ($value instanceof \Symfony\Component\DependencyInjection\Reference) {
            $value = $this->doGet((string) $value, $value->getInvalidBehavior(), $inlineServices, $isConstructorArgument);
        } elseif ($value instanceof \Symfony\Component\DependencyInjection\Definition) {
            $value = $this->createService($value, $inlineServices, $isConstructorArgument);
        } elseif ($value instanceof \Symfony\Component\DependencyInjection\Parameter) {
    ...
    {
        if (!isset($this->autoconfiguredInstanceof[$interface])) {
            $this->autoconfiguredInstanceof[$interface] = new \Symfony\Component\DependencyInjection\ChildDefinition('');
        }
    ...
    public static function getServiceConditionals($value)
    {
        ...
        } elseif ($value instanceof \Symfony\Component\DependencyInjection\Reference && \Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE === $value->getInvalidBehavior()) {
    ...
    public static function getInitializedConditionals($value)
    {
        ...
        } elseif ($value instanceof \Symfony\Component\DependencyInjection\Reference && \Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $value->getInvalidBehavior()) {
            $services[] = (string) $value;
        }
        return $services;
    }
    ...
    private function callMethod($service, $call, array &$inlineServices)
    {
        ...
        foreach (self::getInitializedConditionals($call[1]) as $s) {
            if (!$this->doGet($s, \Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE, $inlineServices)) {
                return;
            }
        }
     ...
     */
    private function shareService(\Symfony\Component\DependencyInjection\Definition $definition, $service, $id, array &$inlineServices)
    {
    ...
    private function getExpressionLanguage()
    {
        if (null === $this->expressionLanguage) {
            ...
            $this->expressionLanguage = new \Symfony\Component\DependencyInjection\ExpressionLanguage(null, $this->expressionLanguageProviders);
        }
