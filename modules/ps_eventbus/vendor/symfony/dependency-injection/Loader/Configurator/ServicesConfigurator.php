...
class ServicesConfigurator extends \Symfony\Component\DependencyInjection\Loader\Configurator\AbstractConfigurator
{
    ...
    {
        return new \Symfony\Component\DependencyInjection\Loader\Configurator\DefaultsConfigurator($this, $this->defaults = new Definition());
    }
    /**
    ...
    protected final function setInstanceof($fqcn)
    {
        ...
        return new \Symfony\Component\DependencyInjection\Loader\Configurator\InstanceofConfigurator($this, $definition, $fqcn);
    }
    /**
     * Registers a service.
     *
    ...
    public final function set($id, $class = null)
    {
        ...
        $configurator = new \Symfony\Component\DependencyInjection\Loader\Configurator\ServiceConfigurator($this->container, $this->instanceof, $allowParent, $this, $definition, $id, $defaults->getTags());
    ...
    public final function alias($id, $referencedId)
    {
        ...
        return new \Symfony\Component\DependencyInjection\Loader\Configurator\AliasConfigurator($this, $alias);
    }
    /**
    ...
    public final function load($namespace, $resource)
    {
        ...
        return new \Symfony\Component\DependencyInjection\Loader\Configurator\PrototypeConfigurator($this, $this->loader, $this->defaults, $namespace, $resource, $allowParent);
    }
    /**
    ...
    public final function get($id)
    {
        ...
        return new \Symfony\Component\DependencyInjection\Loader\Configurator\ServiceConfigurator($this->container, $definition->getInstanceofConditionals(), $allowParent, $this, $definition, $id, []);
    }
    /**
     * Registers a service.
     *
