 ...
 */
namespace ps_eventbus_v3_0_7\Composer;

use ps_eventbus_v3_0_7\Composer\Autoload\ClassLoader;
use ps_eventbus_v3_0_7\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    public static function getInstalledPackages()
    {
        ...
        return \array_keys(\array_flip(\call_user_func_array('ps_eventbus_v3_0_7\\array_merge', $packages)));
    }
    /**
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ps_eventbus_v3_0_7\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
