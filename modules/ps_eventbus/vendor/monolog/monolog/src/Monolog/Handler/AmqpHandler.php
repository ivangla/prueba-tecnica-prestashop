...
use ps_eventbus_v3_0_7\Monolog\Formatter\JsonFormatter;
use ps_eventbus_v3_0_7\PhpAmqpLib\Message\AMQPMessage;
use ps_eventbus_v3_0_7\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
