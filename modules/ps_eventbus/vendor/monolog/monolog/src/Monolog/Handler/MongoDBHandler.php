...
class MongoDBHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!($mongo instanceof \MongoClient || $mongo instanceof \Mongo || $mongo instanceof \ps_eventbus_v3_0_7\MongoDB\Client)) {
    ...
    {
        if ($this->mongoCollection instanceof \ps_eventbus_v3_0_7\MongoDB\Collection) {
