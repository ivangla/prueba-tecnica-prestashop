...
use ps_eventbus_v3_0_7\Monolog\Utils;
use ps_eventbus_v3_0_7\PhpConsole\Connector;
use ps_eventbus_v3_0_7\PhpConsole\Handler;
use ps_eventbus_v3_0_7\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('ps_eventbus_v3_0_7\\PhpConsole\\Connector')) {
