...
class PresenterService
{
    ...
    private function convertObjectToArray($object)
    {
        ...
        // TODO understand why phpstan complains about this
    ...
    public function expose(\ModuleCore $module, $requiredConsents = [], $optionalConsents = [])
    {
        ...
        if ($this->psAccountsAdapterService == null) {
            ...
            return ['jwt' => $this->psAccountsAdapterService->getOrRefreshToken(), 'requiredConsents' => $requiredConsents, 'optionalConsents' => $optionalConsents, 'module' => \array_merge(['logoUrl' => \Tools::getHttpHost(\true) . '/modules/' . $module->name . '/logo.png'], $this->convertObjectToArray($module)), 'shop' => [
                /* @phpstan-ignore-next-line */
                'id' => $this->psAccountsAdapterService->getShopUuid(),
                'name' => \Configuration::get('PS_SHOP_NAME'),
                'url' => \Tools::getHttpHost(\true),
                'lang' => $language->iso_code,
            ], 'psEventbusModule' => $this->convertObjectToArray(\Module::getInstanceByName('ps_eventbus')), 'modulesInformation' => ['psEventbus' => $moduleHelper->buildModuleInformation('ps_eventbus'), 'psMbo' => $moduleHelper->buildModuleInformation('ps_mbo')]];
        }
    }
}
