...
class CurrencyDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($currency) {
            return ['id' => $currency['id_currency'], 'collection' => Config::COLLECTION_CURRENCIES, 'properties' => $currency];
        }, $currencies);
    }
    /**
     * @param int $offset
