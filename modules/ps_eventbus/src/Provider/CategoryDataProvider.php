...
class CategoryDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($category) {
            return ['id' => "{$category['id_category']}-{$category['iso_code']}", 'collection' => Config::COLLECTION_CATEGORIES, 'properties' => $category];
        }, $categories);
    }
    /**
     * @param int $offset
