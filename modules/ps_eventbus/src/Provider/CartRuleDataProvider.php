...
class CartRuleDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        if (\is_array($cartRules)) {
            return \array_map(function ($cartRule) {
                return ['id' => $cartRule['id_cart_rule'], 'collection' => Config::COLLECTION_CART_RULES, 'properties' => $cartRule];
            }, $cartRules);
        }
        return [];
    }
