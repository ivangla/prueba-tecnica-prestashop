...
class CarrierDataProvider implements ProviderPaginatedApiDataProviderInterface
{
    ...
    public function __construct(ConfigurationRepository $configurationRepository, CarrierBuilder $carrierBuilder, CarrierRepository $carrierRepository, LanguageRepository $languageRepository)
    {
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        $eventBusCarriers = $this->carrierBuilder->buildCarriers($carriers, $langId, $currency, $configurationPsWeightUnit);
