...
class ManufacturerDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($manufacturer) {
            return ['id' => $manufacturer['id_manufacturer'], 'collection' => Config::COLLECTION_MANUFACTURERS, 'properties' => $manufacturer];
        }, $manufacturers);
    }
    /**
     * @param int $offset
