...
class ModuleDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($module) {
            ...
            return ['id' => $module['module_id'], 'collection' => Config::COLLECTION_MODULES, 'properties' => $module];
        }, $modules);
    }
    /**
     * @param int $offset
