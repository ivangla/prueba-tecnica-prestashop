...
class ImageDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
     * @var ImageRepository
     */
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($image) {
            return ['id' => "{$image['id_image']}", 'collection' => Config::COLLECTION_IMAGES, 'properties' => $image];
        }, $images);
    }
    /**
     * @param int $offset
