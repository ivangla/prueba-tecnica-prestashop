...
class SupplierDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($supplier) {
            return ['id' => $supplier['id_supplier'], 'collection' => Config::COLLECTION_SUPPLIERS, 'properties' => $supplier];
        }, $suppliers);
    }
    /**
     * @param int $offset
