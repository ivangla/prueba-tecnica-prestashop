...
class ImageTypeDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($imageType) {
            return ['id' => "{$imageType['id_image_type']}", 'collection' => Config::COLLECTION_IMAGE_TYPES, 'properties' => $imageType];
        }, $imageTypes);
    }
    /**
     * @param int $offset
