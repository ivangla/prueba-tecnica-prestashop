...
class EmployeeDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($employee) {
            return ['id' => "{$employee['id_employee']}", 'collection' => Config::COLLECTION_EMPLOYEES, 'properties' => $employee];
        }, $employees);
    }
    /**
     * @param int $offset
    ...
    public function getFormattedDataIncremental($limit, $langIso, $objectIds)
    {
        ...
        $this->employeeDecorator->decorateEmployees($employees);
        return \array_map(function ($employee) {
            return ['id' => "{$employee['id_customer']}", 'collection' => Config::COLLECTION_EMPLOYEES, 'properties' => $employee];
        }, $employees);
    }
    /**
     * @param int $offset
