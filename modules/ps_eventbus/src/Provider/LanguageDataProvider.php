...
class LanguageDataProvider implements \PrestaShop\Module\PsEventbus\Provider\PaginatedApiDataProviderInterface
{
    /**
    ...
    public function getFormattedData($offset, $limit, $langIso)
    {
        ...
        return \array_map(function ($language) {
            return ['id' => $language['id_lang'], 'collection' => Config::COLLECTION_LANGUAGES, 'properties' => $language];
        }, $languages);
    }
    /**
     * @param int $offset
