...
use ps_eventbus_v3_0_7\Prestashop\ModuleLibMboInstaller\Installer as MBOInstaller;
...
class PsEventbusResolverController extends FrameworkBundleAdminController
{
    ...
    public function upgradeModule()
    {
        ...
        return new Response($upgrade->upgradePsEventbus(), 200, ['Content-Type' => 'application/json']);
    }
}
